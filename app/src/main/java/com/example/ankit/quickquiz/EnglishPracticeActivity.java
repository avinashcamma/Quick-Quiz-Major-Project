...
public class EnglishPracticeActivity extends AppCompatActivity implements View.OnClickListener {

    public static final String LOG_TAG = EnglishPracticeActivity.class.getName();
    ...
    int[] englishQuestionIdsArray;

    @BindView(R.id.tv_question_epa)
    TextView questionTextView;
    @BindView(R.id.bt_button1_epa)
    Button option1Button;
    @BindView(R.id.bt_button2_epa)
    Button option2Button;
    @BindView(R.id.bt_button3_epa)
    Button option3Button;
    @BindView(R.id.bt_button4_epa)
    Button option4Button;
    @BindView(R.id.bt_next_epa)
    Button nextButton;
    @BindView(R.id.bt_see_ans_epa)
    ...
    @BindView(R.id.pb_loading_questions_epa)
    ProgressBar spinner;
    @BindView(R.id.cl_questions_layout)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_practice);
        ...
        try {
            englishQuestionIdsArray = mCustomContentProvider.getEnglishQuestions();
        } catch (Exception e) {
            e.printStackTrace();
        }
        /**
...
//        QUESTION_ID_URL += id;
    ...
    private int getRandomInt() {
        ...
        return englishQuestionIdsArray[random.nextInt(englishQuestionIdsArray.length - 0)];
    }
}
