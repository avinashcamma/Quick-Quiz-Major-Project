...
public class ReasoningPracticeActivity extends AppCompatActivity implements View.OnClickListener {
    public static final String LOG_TAG = ReasoningPracticeActivity.class.getName();
    ...
    int[] reasoningQuestionIdsArray;

    @BindView(R.id.tv_question_rpa)
    TextView questionTextView;
    @BindView(R.id.bt_button1_rpa)
    Button option1Button;
    @BindView(R.id.bt_button2_rpa)
    Button option2Button;
    @BindView(R.id.bt_button3_rpa)
    Button option3Button;
    @BindView(R.id.bt_button4_rpa)
    Button option4Button;
    @BindView(R.id.bt_next_rpa)
    Button nextButton;
    @BindView(R.id.bt_see_ans_rpa)
    ...
    @BindView(R.id.pb_loading_questions_rpa)
    ProgressBar spinner;
    @BindView(R.id.rpa_cl_questions_layout)
    CoordinatorLayout mCoordinatorLayout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_reasoning_practice);

        ButterKnife.bind(this);
        mContext = this;
        mCustomContentProvider = new CustomContentProvider(mContext);
        reasoningQuestionIdsArray = mCustomContentProvider.getReasoningQuestions();
...
//        QUESTION_ID_URL += id;
    ...
    private int getRandomInt() {
        ...
        return reasoningQuestionIdsArray[random.nextInt(reasoningQuestionIdsArray.length - 0)];
    }
}
